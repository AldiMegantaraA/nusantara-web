        ...
        <div className="flex flex-col justify-between h-full text-left">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <button type="button" onClick={() => scrollToSection("contact-us")} className="text-white px-8 py-4 rounded-full font-semibold hover:bg-white/10 transition-all duration-300 flex items-center space-x-2">
