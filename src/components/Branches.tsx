...
const Branches = () => {
  ...
  const brands = ['Scomadi', 'Honda', 'Royal Enfield', 'Hyundai', 'Mercedes', 'Ford', 'Chevrolet'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12">
          ...
          <div className="lg:max-w-md">
            <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              Lorem ipsum sir dolor amet Lorem ipsum sir dolor amet Lorem ipsum sir dolor amet Lorem ipsum sir dolor amet.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-6">
            <span className="text-gray-400 text-sm font-medium">Select brand</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {branches.map((branch, index) => (
            <div key={index} className="bg-gray-700 rounded-2xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
